// 改编自 compose-miuix-ui 的 IosLiquidGlassNavigationBar 示例，遵循 Apache 2.0。

package one.only.player.ui.component
...
import one.only.player.ui.component.liquid.rememberCombinedBackdrop
import one.only.player.ui.component.liquid.vibrancy
import one.only.player.ui.component.miuix.animation.DampedDragAnimation
import one.only.player.ui.component.miuix.animation.InteractiveHighlight
...
private const val GRAVITY_DIR_THRESHOLD_SQ = 0.01f // |g_xy| > 0.1, ≈ 6° 倾斜

// 让 dualPeak 高光的主光源跟随重力方向，并叠加额外的 UV 顺时针偏移
@Composable
            ...
            Modifier
                ...
                .dropShadow(
                    ...
                    shadow = Shadow(
                        ...
                        alpha = if (isInDark) 0.15f else 0.1f,
                    ),
                )
                .clickable(

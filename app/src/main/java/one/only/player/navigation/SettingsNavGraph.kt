...
import one.only.player.settings.navigation.fileExtensionPreferencesScreen
...
import one.only.player.settings.navigation.navigateToFileExtensionPreferencesScreen
...
fun NavGraphBuilder.settingsNavGraph(
    ...
    navigation(
        ...
        mediaLibraryPreferencesScreen(
            ...
            onFileExtensionSettingClick = navController::navigateToFileExtensionPreferencesScreen,
        )
        ...
        fileExtensionPreferencesScreen(
            onNavigateUp = navController::navigateUp,
        )
